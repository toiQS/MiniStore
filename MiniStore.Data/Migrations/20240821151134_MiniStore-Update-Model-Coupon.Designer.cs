...
namespace MiniStore.Data.Migrations
{
    ...
    [Migration("20240821151134_MiniStore-Update-Model-Coupon")]
    partial class MiniStoreUpdateModelCoupon
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MiniStore.Models.Coupon", b =>
                {
                    ...
                    b.Property<string>("ApplyToItem")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("Apply To Item");
