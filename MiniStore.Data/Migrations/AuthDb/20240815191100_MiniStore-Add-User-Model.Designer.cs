...
namespace MiniStore.Data.Migrations.AuthDb
{
    ...
    [Migration("20240815191100_MiniStore-Add-User-Model")]
    partial class MiniStoreAddUserModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniStore.Data.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MiniStore.Data.User", null)
                        .WithMany()
